...
namespace INFORAP.API.Persistence.Migrations
{
    ...
    [Migration("20200906233932_us_23_upd_cliente")]
    partial class us_23_upd_cliente
    {
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.MotivoBajaServicio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(5972),
                            CreationUserId = 1,
                            Descripcion = "Fecha de finalización cumplida",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(5962),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(6033),
                            CreationUserId = 1,
                            Descripcion = "Decisión del cliente",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(6031),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(6040),
                            CreationUserId = 1,
                            Descripcion = "Decisión propia",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(6037),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRecurso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(1371),
                            CreationUserId = 1,
                            Descripcion = "Recurso Humano",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 39, 31, 570, DateTimeKind.Local).AddTicks(7401),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(2833),
                            CreationUserId = 1,
                            Descripcion = "Recurso Material",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(2811),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(2870),
                            CreationUserId = 1,
                            Descripcion = "Recurso Renovable",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 39, 31, 572, DateTimeKind.Local).AddTicks(2868),
                            UpdateUserId = 1
                        });
                });
