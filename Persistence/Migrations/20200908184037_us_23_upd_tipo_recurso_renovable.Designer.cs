...
namespace INFORAP.API.Persistence.Migrations
{
    ...
    [Migration("20200908184037_us_23_upd_tipo_recurso_renovable")]
    partial class us_23_upd_tipo_recurso_renovable
    {
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.MotivoBajaServicio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(617),
                            CreationUserId = 1,
                            Descripcion = "Fecha de finalización cumplida",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(608),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(677),
                            CreationUserId = 1,
                            Descripcion = "Decisión del cliente",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(675),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(683),
                            CreationUserId = 1,
                            Descripcion = "Decisión propia",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(681),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRecurso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 821, DateTimeKind.Local).AddTicks(5952),
                            CreationUserId = 1,
                            Descripcion = "Recurso Humano",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 820, DateTimeKind.Local).AddTicks(2256),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 821, DateTimeKind.Local).AddTicks(7496),
                            CreationUserId = 1,
                            Descripcion = "Recurso Material",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 821, DateTimeKind.Local).AddTicks(7474),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 821, DateTimeKind.Local).AddTicks(7536),
                            CreationUserId = 1,
                            Descripcion = "Recurso Renovable",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 821, DateTimeKind.Local).AddTicks(7533),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRegla", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2770),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro recurso con periodo de asignación",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2762),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2849),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro con fecha de vencimiento vigente",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2846),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2855),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro sin fecha de vencimiento ni periodicidad",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2853),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2860),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga un ciclo de vida no menor a X tiempo",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2858),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2865),
                            CreationUserId = 1,
                            Descripcion = "Un recurso no debe estar fuera de servicio por X  tiempo",
                            UpdateDate = new DateTime(2020, 9, 8, 15, 40, 36, 822, DateTimeKind.Local).AddTicks(2863),
                            UpdateUserId = 1
                        });
                });
