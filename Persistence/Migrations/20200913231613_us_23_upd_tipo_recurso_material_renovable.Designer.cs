...
namespace INFORAP.API.Persistence.Migrations
{
    ...
    [Migration("20200913231613_us_23_upd_tipo_recurso_material_renovable")]
    partial class us_23_upd_tipo_recurso_material_renovable
    {
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.MotivoBajaServicio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(5337),
                            CreationUserId = 1,
                            Descripcion = "Fecha de finalización cumplida",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(5327),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(5396),
                            CreationUserId = 1,
                            Descripcion = "Decisión del cliente",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(5394),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(5405),
                            CreationUserId = 1,
                            Descripcion = "Decisión propia",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(5400),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRecurso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(684),
                            CreationUserId = 1,
                            Descripcion = "Recurso Humano",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 310, DateTimeKind.Local).AddTicks(7026),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(2241),
                            CreationUserId = 1,
                            Descripcion = "Recurso Material",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(2221),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(2278),
                            CreationUserId = 1,
                            Descripcion = "Recurso Renovable",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(2276),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRegla", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7487),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro recurso con periodo de asignación",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7480),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7556),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro con fecha de vencimiento vigente",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7554),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7563),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro sin fecha de vencimiento ni periodicidad",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7561),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7567),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga un ciclo de vida no menor a X tiempo",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7566),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7572),
                            CreationUserId = 1,
                            Descripcion = "Un recurso no debe estar fuera de servicio por X  tiempo",
                            UpdateDate = new DateTime(2020, 9, 13, 20, 16, 12, 312, DateTimeKind.Local).AddTicks(7570),
                            UpdateUserId = 1
                        });
                });
