...
namespace INFORAP.API.Persistence.Migrations
{
    ...
    [Migration("20200906232409_us_23_add_tipo_recurso_values")]
    partial class us_23_add_tipo_recurso_values
    {
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.MotivoBajaServicio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(5468),
                            CreationUserId = 1,
                            Descripcion = "Fecha de finalización cumplida",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(5458),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(5524),
                            CreationUserId = 1,
                            Descripcion = "Decisión del cliente",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(5521),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(5530),
                            CreationUserId = 1,
                            Descripcion = "Decisión propia",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(5528),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRecurso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(331),
                            CreationUserId = 1,
                            Descripcion = "Recurso Humano",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 24, 8, 440, DateTimeKind.Local).AddTicks(6669),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(1782),
                            CreationUserId = 1,
                            Descripcion = "Recurso Material",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(1763),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(1824),
                            CreationUserId = 1,
                            Descripcion = "Recurso Renovable",
                            UpdateDate = new DateTime(2020, 9, 6, 20, 24, 8, 442, DateTimeKind.Local).AddTicks(1822),
                            UpdateUserId = 1
                        });
                });
