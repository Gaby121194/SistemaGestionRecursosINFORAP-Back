...
namespace INFORAP.API.Persistence.Migrations
{
    ...
    [Migration("20200907183858_us_23_add_tipo_regla_values")]
    partial class us_23_add_tipo_regla_values
    {
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.MotivoBajaServicio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(9271),
                            CreationUserId = 1,
                            Descripcion = "Fecha de finalización cumplida",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(9262),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(9326),
                            CreationUserId = 1,
                            Descripcion = "Decisión del cliente",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(9324),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(9332),
                            CreationUserId = 1,
                            Descripcion = "Decisión propia",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(9330),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRecurso", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(4605),
                            CreationUserId = 1,
                            Descripcion = "Recurso Humano",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 782, DateTimeKind.Local).AddTicks(907),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(6050),
                            CreationUserId = 1,
                            Descripcion = "Recurso Material",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(6029),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(6088),
                            CreationUserId = 1,
                            Descripcion = "Recurso Renovable",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 783, DateTimeKind.Local).AddTicks(6086),
                            UpdateUserId = 1
                        });
                });
            ...
            modelBuilder.Entity("INFORAP.API.Persistence.Context.TipoRegla", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1447),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro recurso con periodo de asignación",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1440),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 2,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1523),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro con fecha de vencimiento vigente",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1521),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 3,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1529),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga asignado otro sin fecha de vencimiento ni periodicidad",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1527),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 4,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1534),
                            CreationUserId = 1,
                            Descripcion = "Un recurso tenga un ciclo de vida no menor a X tiempo",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1532),
                            UpdateUserId = 1
                        },
                        new
                        {
                            Id = 5,
                            Active = true,
                            CreationDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1539),
                            CreationUserId = 1,
                            Descripcion = "Un recurso no debe estar fuera de servicio por X  tiempo",
                            UpdateDate = new DateTime(2020, 9, 7, 15, 38, 57, 784, DateTimeKind.Local).AddTicks(1537),
                            UpdateUserId = 1
                        });
                });
